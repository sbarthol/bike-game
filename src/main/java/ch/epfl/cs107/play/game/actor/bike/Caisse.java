...
public class Caisse extends GameEntity implements Actor {
	
	private ImageGraphics graphics;

	public Caisse(ActorGame game, boolean fixed, Vector vector, String image, float width, float height) throws IllegalArgumentException {
